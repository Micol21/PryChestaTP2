...
namespace PryChestaTP2
{
    internal class ClsAccesoDatos
    {
        ...
        string cadenaConexion = @"Provider = Microsoft.ACE.OLEDB.12.0; Data Source = C:..\\..\\Resources\\EMPLEADO.accdb";
        ...
        public void RegistrarDatosDataSet(string nombre, string Apellido)
        {
            try
            {
                ConectarBD();
                ...
                comandoBD.CommandText = "DATOS PERSONALES";//que tabla traigo
            ...
            try
            {
...

                {
                    ...
                    foreach (DataRow fila in objDataSet.Tables[0].Rows)
                    {
                        ...
                        grilla.Rows.Add(fila[0], fila[1], fila[2], fila[3], fila[4], fila[5]);
                    }
                }
            }
            catch (Exception ex)
        ...
        public void TraerDatos(DataGridView grilla)
        {
            try
            {
                ...
                {//si el lector puede leer hay datos, lee un registro (conjunto de datos heterogeneos) 
                    {
                        grilla.Rows.Add(lectorBD[1], lectorBD[2], lectorBD[3], lectorBD[4], lectorBD[5] );
                    }
